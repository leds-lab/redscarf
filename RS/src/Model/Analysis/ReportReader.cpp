    ...
    if( (fpIn = fopen(file,"rt")) == NULL  ) {
        ...
        do {
            ...
            if(scanResult != EOF) {
                ...
                scanResult = fscanf(fpIn,"%s", str);
                avgRequiredBwNorm = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                acceptedTrafficFlits = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                idealAvgLatency = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                avgLatencyCycles = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                stdevLatency = atof(str);
                ...
                scanResult = fscanf(fpIn,"%s", str);
                avgRequiredBwBps = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                acceptedTrafficBps = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                idealAvgLatencyNs = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                avgLatencyNs = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                minLatencyNs = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                maxLatencyNs = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                metDeadlinesPer0 = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                metDeadlinesPer1 = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                metDeadlinesPer2 = atof(str);

                scanResult = fscanf(fpIn,"%s", str);
                metDeadlinesPer3 = atof(str);
