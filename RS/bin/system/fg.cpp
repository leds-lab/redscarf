...
////////////////////////////////////////////////////////////////////////////////
void fg::f_send_flit(sc_uint<FLIT_WIDTH> flit, unsigned int /*traffic_class*/)
////////////////////////////////////////////////////////////////////////////////
{
    snd_wr.write(0);
    snd_data.write(flit);
...
//    unsigned long long ull_temp;
    ...
    // It sends the header
    flit = ( sc_uint<FLIT_WIDTH> ) ( (unsigned long long) ( (((unsigned long long)HEADER_FRAME)<<(FLIT_WIDTH-2))
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
void fg::f_send_burst_of_packets(sc_uint<FLIT_WIDTH> header, unsigned long long cycle_to_send, FLOW_TYPE flow)
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
    unsigned int i;
...
////////////////////////////////////////////////////////////////////////////////
{
    ...
    while(1) {
        if ((rcv_rok.read()==1) && ((rcv_data.read()>>DATA_WIDTH) & 0x2))
