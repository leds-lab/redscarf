...
SC_MODULE(xin_ag)
{
    ...
    sc_signal<sc_uint<FLIT_WIDTH> > fifo_dout_wire;     // FIFO's data output (it goes to stampler)
    ...
    SC_HAS_PROCESS(xin_ag);

    //////////////////////////////////////////////////////////////////////////////
    xin_ag(sc_module_name nm,	unsigned short int USE_THIS, unsigned short int XID,
           unsigned short int YID, unsigned short int PORT_ID,
           unsigned short int CHANNEL_ID) : sc_module(nm), USE_THIS(USE_THIS),
      ...
      //////////////////////////////////////////////////////////////////////////////
    {
        if (USE_THIS) {
            ...
            ///////////////////////////////////////////////////////////////////////////////
            stampler *stampler0 = new stampler("stampler0", XID, YID, PORT_ID, CHANNEL_ID);// INCLUDED IN THE IMPLEMENTATION OF QoS
            ///////////////////////////////////////////////////////////////////////////////
            stampler0->i_CLK(clk);
            stampler0->i_RST(rst);
            stampler0->i_ROK(rok_wire);
            stampler0->i_DIN(fifo_dout_wire);
            stampler0->o_DOUT(x_dout);
