...
#define FLOW_ID_POSITION        16
#define MIN_PAYLOAD_LENGTH      3

//#define CALC_PERFORMANCE_PARAMETERS

////////////////////////////////////////////////////////////////////////////////
void t_probe::f_write_received_flit(FILE *fp_out)
////////////////////////////////////////////////////////////////////////////////
{
//    float               offered_load;
//    float               accepted_traffic;
    ...
    if (bop == 1) {
        ...
        flow_id           = (unsigned int) ((header >> FLOW_ID_POSITION)) & 0x3;
    ...
    if (eop==1) {
        ...
        fprintf(fp_out,"  %.2f\t" ,round(((float) required_bw)));
        fprintf(fp_out,"\n");
        pck_size = 0;
    }
}
...
////////////////////////////////////////////////////////////////////////////////
{
    ...
    if ((fp_out=fopen(path_filename,"wt")) == NULL) {
        printf("\n\t[t_probe.cpp] ERROR: Impossible to open file \"%s\". Exiting...", path_filename);
        exit(1);
    }
    ...
    fprintf(fp_out,"\n    Packet\tXd\tYd\tXs\tYs\tFID\tClass\tDeadline\t     Packet\t    Header\t   Trailer\t Packet\t    Req");
#ifdef CALC_PERFORMANCE_PARAMETERS            
