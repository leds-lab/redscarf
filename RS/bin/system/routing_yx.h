...
FILE   : routing_xy.h
--------------------------------------------------------------------------------
DESCRIPTION: Implements the YX routing algorithm. It takes as parameters the
...
--------------------------------------------------------------------------------
*/
#ifndef __ROUTING_YX_H__
#define __ROUTING_YX_H__

#include <systemc.h>
#include "parameters.h"

////////////////////////////////////////////////////////////////////////////////
SC_MODULE(routing_yx)
////////////////////////////////////////////////////////////////////////////////
{
    // FIFO interface
    ...
    SC_HAS_PROCESS(routing_yx);

    //////////////////////////////////////////////////////////////////////////////
    routing_yx(sc_module_name nm, unsigned short int XID, unsigned short int YID):
